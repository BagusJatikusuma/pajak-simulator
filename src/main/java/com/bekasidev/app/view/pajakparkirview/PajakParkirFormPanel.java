 ...
 * @author Bayu Arafli
 */
public class PajakParkirFormPanel extends JPanel{

    public PajakParkirFormPanel() {
        ComponentCollectorProvider.addComponent("pajak_parkir_form_panel", this, null, null);
        init();
    }
    ...
    public void init(){
        ...
        FormPersiapanParkirPanel formPersiapanPanel = new FormPersiapanParkirPanel();
