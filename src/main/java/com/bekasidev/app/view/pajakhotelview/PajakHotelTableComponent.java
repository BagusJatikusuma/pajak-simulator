 ...
 * @author Bayu Arafli
 */
public class PajakHotelTableComponent extends JPanel {
    private HotelService service;

    public PajakHotelTableComponent() {
        ComponentCollectorProvider.addComponent("pajak_hotel_table_component", this, null, null);
        init();
    }
