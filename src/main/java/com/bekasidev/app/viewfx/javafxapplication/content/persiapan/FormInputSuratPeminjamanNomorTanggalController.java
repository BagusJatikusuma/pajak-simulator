 ...
 * @author sudoroot
 */
public class FormInputSuratPeminjamanNomorTanggalController implements Initializable {
    ...
    public void tambahOperation() {
        ...
        for (NomorTanggalWajibPajakWrapper obj
            ...
            if (obj.getWajibPajak().getNpwpd()
                ...
                obj.setNomorPeminjamanDokumen(nomorSuratField.getText());
                obj.setTanggalPeminjamanDokumen(Date.from(tanggalPengesahanField.getValue().atStartOfDay(ZoneId.systemDefault()).toInstant()));
            }
